            ...
            <?php $i = 1;?>
                @foreach ($data_user as $d)
                  <tr>
                    <td>{{ $d->nama }}</td>
                    <td>{{ $d->jumlah}}</td>
                    <td>{{ $d->harga*$d->jumlah*$d->diskon/100}}</td>
                    <td>{{ $d->diskon}}</td>
                   ...
                   <div class="modal fade" id="exampleModals{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <form method="post" action="{{route('delete_order_d')}}">
                        @csrf
                    ...
                    <div class="modal fade" id="exampleModalss{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                      <form method="post" action="{{route('edit_order_d')}}">
                      @csrf
                        <div class="modal-content">
                          <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <div class="form-group row" style="margin-left:-120px;">
                            <label class="col-sm-2 col-form-label" style="margin-left: 150px;">ID Order</label>
                            <div class="col-sm-6">
                              <select  name="id_order_h" class="form-control" placeholder="" required>
                                @foreach($data as $z)
                          ...
                          <div class="form-group row" style="margin-left:-120px;">
                            ...
                            <div class="col-sm-6">
                              <select  name="diskon" class="form-control" placeholder="" required>
                                @foreach($datass as $z)
                                  <option value="{{$z->diskon}}">{{$z->diskon}}</option>
                                @endforeach
                              </select>
                            </div>
                          </div>  
                          <div class="form-group row" style="margin-left:-120px;">
                            <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Jumlah</label>
                            <div class="col-sm-6">
                              <input type="number" name="jumlah" value="{{$d->jumlah}}" class="form-control" placeholder="" required>
                            </div>
                          </div>  
                        </div>
                        <div class="modal-footer">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
  <form method="post" action="{{ route('add_order_d') }}">
  @csrf
    <div class="modal-content">
      <div class="modal-header">
