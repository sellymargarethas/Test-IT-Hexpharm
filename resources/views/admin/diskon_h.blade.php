                  ...
                  <tr>
                   ...
                   <div class="modal fade" id="exampleModals{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <form method="post" action="{{route('delete_diskon_h')}}">
                        @csrf
                    ...
                    <div class="modal fade" id="exampleModalss{{$i}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                      <form method="post" action="{{route('edit_diskon_h')}}">
                      @csrf
                        <div class="modal-content">
                          <div class="modal-header">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group row" style="margin-left:-120px;">
                            <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Awal</label>
                            <div class="col-sm-6">
                              <input type="datetime-local" name="awal" class="form-control" value="{{$d->awal}}" placeholder="" required>
                            </div>
                          </div>  
                          <div class="form-group row" style="margin-left:-120px;">
                            <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Akhir</label>
                            <div class="col-sm-6">
                              <input type="datetime-local" name="akhir" class="form-control" value="{{$d->akhir}}" placeholder="" required>
                            </div>
                          </div>   
                        </div>
                        <div class="modal-footer">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
  <form method="post" action="{{ route('add_diskon_h') }}">
  @csrf
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Awal</label>
          <div class="col-sm-6">
            <input type="datetime-local" name="awal" class="form-control" placeholder="" required>
          </div>
        </div>  
        <div class="form-group row" style="margin-left:-120px;">
          <label class="col-sm-2 col-form-label" style="margin-left: 150px;">Akhir</label>
          <div class="col-sm-6">
            <input type="datetime-local" name="akhir" class="form-control" placeholder="" required>
          </div>
        </div>  
